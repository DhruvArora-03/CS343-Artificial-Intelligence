    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((nextx, nexty, tuple(corners.copy())), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    for i in range(4):
        if not state[2][i]:
            highest = max(highest, util.manhattanDistance(state[0:2], corners[i]))
...
def foodHeuristic(state, problem):
    ...
    for food in foodList:
        # max_dist = max(max_dist, util.manhattanDistance(position, food))
